    ...
    <main className="min-h-screen bg-gradient-to-br from-white to-primary-light/30 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="pt-20 px-4">
        <div className="max-w-4xl mx-auto text-center py-20">
          <Info className="w-20 h-20 text-primary mx-auto mb-6" />
          <h1 className="text-4xl font-amiri text-gold mb-2">عنا</h1>
          <h2 className="text-3xl font-nastaliq font-bold text-primary mb-4 rtl">ہمارے بارے میں</h2>
