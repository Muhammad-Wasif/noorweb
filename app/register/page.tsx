...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      if (success) {
        toast.success('کامیابی سے رجسٹر ہو گئے!')
        router.push('/explore')
      } else {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-white to-primary-light overflow-y-auto">
        <motion.div
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                {password && (
                  <div className="mt-2">
                    ...
                    <ul className="mt-2 space-y-1 text-xs rtl font-nastaliq">
                      ...
                      <li className={/[0-9]/.test(password) ? 'text-green-500' : 'text-gray-400'}>
                        ✓ ایک نمبر (0-9)
                      </li>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`input-field pl-10 pr-12 ${errors.confirmPassword ? 'input-error' : ''}`}
                    placeholder="••••••••"
                    dir="ltr"
                  />
                  <button
              ...
              >
                {isLoading ? (
                  ...
                  <span className="font-nastaliq">رجسٹر کریں</span>
                )}
              </button>
            </form>
